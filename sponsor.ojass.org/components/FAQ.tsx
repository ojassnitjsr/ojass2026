  ...
  const faqs: FAQItem[] = [
    {
      ...
      answer: "We offer customized tiers covering on-ground branding, digital campaigns, stage integrations, booths, and recruitment add-ons. Share your goals and we’ll tailor a package.",
    },
    {
